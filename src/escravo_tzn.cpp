...
const char* TOPICO_LAMPADA = "sdkjgsdgryf45h3746/CAIXA/lampada2";
const char* CLIENT_ID = "esp32slave_2";
...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect("esp32slave_2")) {
      Serial.println("Conectado ao broker!");
      client.subscribe("sdkjgsdgryf45h3746/CAIXA/lampada2");
    } else {
